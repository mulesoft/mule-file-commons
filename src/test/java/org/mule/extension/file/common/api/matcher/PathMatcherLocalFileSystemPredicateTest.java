...
public class PathMatcherLocalFileSystemPredicateTest {
  ...
  public void globPattern1() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("*.txt");
  ...
  public void globPattern2() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("s?t.txt");
  ...
  public void globPatternWithBraces() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("*.{java,clas?}");
  ...
  public void globPatternWithEscapes() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("\\{a,b}");
    assertTrue(pmp.test("{a,b}"));
  }

  @Test
  public void globPatternWithBrackets() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("b[aei{}]d");
  ...
  public void globPatternWithBracketsRegexQuoting() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("\\Qa");
  ...
  public void globPatternWithBracketsAndMisplacedRegex() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("a[[:digit:]]z");
  ...
  public void regexPattern1() {
    PathMatcherPredicate pmp = new PathMatcherPredicate("regex:.*\\.txt");
    assertTrue(pmp.test("hello.txt"));
    assertTrue(pmp.test(".txt"));
    assertFalse(pmp.test("hello.csv"));
  }
  ...
  private void assertBadPattern(String path, String pattern) {
    ...
    try {
      PathMatcherPredicate pmp = new PathMatcherPredicate(pattern);
      pmp.test(path);
  ...
  public void assertRegExMatch(String path, String pattern) {
    ...
    PathMatcherPredicate pmp = new PathMatcherPredicate("regex:" + pattern);
